...
def run_after_task(
    ...
    ingest_week4_memory_record(task_id, summary)
...
def ingest_week4_memory_record(task_id: str, summary: dict):
    ...
    lifecycle.ingest({
        ...
        "task_id": task_id,
        "content": summary.get("result_summary") or summary.get("error_message") or "",
