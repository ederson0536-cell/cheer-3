...
## Unified Memory Record (v1)

All memory entries under:
`memory/experiences/`, `memory/significant/`, `memory/semantic/`,
`memory/candidate/`, `memory/proposals/`
should use this shared shape:
...
Machine-readable JSON Schema: `evoclaw/references/unified_memory.schema.json`
