...
def main(workspace_root='.'):
    ...
    print('🔍 [2/9] Validating reflections...')
    ...
    print('🔍 [3/9] Validating proposals against SOUL.md...')
    ...
    print('🔍 [4/9] Validating SOUL.md structure...')
    ...
    print('🔍 [5/9] Validating state file...')
    ...
    print('🔍 [6/9] Checking pipeline completeness...')
    results['pipeline'] = run_validator(
        'check_pipeline_ran.py',
        [memory_dir, '--since-minutes', '30']
    )

    # 7. Hardcoded workspace path guardrail
    print('🔍 [7/9] Checking hardcoded workspace paths...')
    results['workspace_paths'] = run_validator('check_no_hardcoded_workspace_path.py', [])


    # 8. Memory DB ownership contract coverage
    print('🔍 [8/9] Checking memory DB ownership contract...')
    results['memory_ownership'] = run_validator('check_memory_db_ownership.py', [])
