# Scoring script
The scoring script is used by any skill created by Moltron to evaluate itself.

Once you finish writing the skill code, create a file called score.js in the project root, and copy the following code as-is in it.
